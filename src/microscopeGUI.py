...
class MicroscopeGUI():
    ...
    def __init__(self):
        ...
        ### Instruments Tab ###
        def instruments_tab():
            self.configDropdown = ttk.Combobox(instrumentsTab, values=self.instruments.fgConfigNames)
        ...
        def amplifier_tab():
            ...
            self.timeConstantDropDown = ttk.Combobox(lockInTab, values=self.instruments.time_constants)
            ...
            self.gainDropDown = ttk.Combobox(lockInTab, values=self.instruments.sensitivities)
    ...
    def select_file_location(self):
        # TODO: Add Functionality
        fileStorageLocation = str(tk.filedialog.askdirectory())
